package com.thentrees.ddd.controller.model.enums;
...
public enum ResultCode {
     ...
     * Tham số bất thường
     */
    PARAM_ERROR(4002, "Tham số bất thường"),

    /**
     * Mã lỗi trả về
     */
    DEMO_SITE_FORBIDDEN_ERROR(4001, "Trang web demo không được phép truy cập"),
     ...
     * 2xxx
     */
    USER_SESSION_EXPIRED(20004, "Phiên làm việc hết hạn, vui lòng đăng nhập lại"),
    USER_PERMISSION_ERROR(20005, "Không có quyền truy cập"),
    USER_PASSWORD_ERROR(20010, "Mật khẩu không đúng"),
    USER_AUTH_ERROR(20006, "Tài khoản hoặc mật khẩu không đúng"),
    EMPLOYEE_NOT_FOUND(20027, "Nhân viên không tồn tại"),
    EMPLOYEE_DISABLED(20031, "Nhân viên đã bị vô hiệu hóa"),
    USER_NOT_FOUND(20002, "Người dùng không tồn tại"),
